...
date: 2014-12-25
title: rsync使用说明#简单配置文档
tags: rsync
category: Linux
status: publist
summary: rsycn config
-->
...
--------------------------------
````
### 简单测试实现，将远程rsync服务器上的数据同步到本地
```
/usr/bin/rsync -avz --progress --bwlimit=1000 --password-file=/etc/rsyncd/rsync.password backuser@192.168.10.158::backup  /home/dbbackup/
```
